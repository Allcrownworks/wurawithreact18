// import { CornerRightDown, CornerRightUp, Zap } from "lucide-react";
           ...
           <div className="w-full  flex flex-col flex-1 ">
                ...
                <div className="flex place-items-center justify-between p-4">
                  ...
                  <div className="flex gap-2 place-items-center">
                    ...
                    <p>
                      {/* <Zap className="w-4 h-4 text-blue-500 hover:text-gray-500 cursor-pointer" /> */}
                    </p>
                  </div>
                </div>
              </div>
             ...
             <div className="w-full  flex flex-col flex-1 ">
                ...
                <div className="flex place-items-center justify-between p-4">
                  ...
                  <div className="flex gap-2 place-items-center">
                    ...
                    <p>
                      {/* <CornerRightUp className="w-4 h-4 text-cyan-400 hover:text-gray-500 cursor-pointer" /> */}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full  flex flex-col flex-1 ">
                ...
                <div className="flex place-items-center justify-between p-4">
                  ...
                  <div className="flex gap-2 place-items-center text-green-400">
                    ...
                    <p>
                      {/* <CornerRightUp className="w-4 h-4  hover:text-gray-500 cursor-pointer" /> */}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full  flex flex-col flex-1">
                ...
                <div className="flex place-items-center justify-between p-4 ">
                  ...
                  <div className="flex gap-2 place-items-center">
                    ...
                    <p>
                      {/* <CornerRightDown className="w-4 h-4 text-red-400 hover:text-gray-500 cursor-pointer" /> */}
                    </p>
                  </div>
                </div>
              </div>
